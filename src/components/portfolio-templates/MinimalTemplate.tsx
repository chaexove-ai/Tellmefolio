 ...
 */
export default function MinimalTemplate({ portfolio, projects, coverUrl, images = {}, blocks = {}, blockEditor, eagerImages, bodyFontStack, lang = "ko" }: PortfolioTemplateProps) {
